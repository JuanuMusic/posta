...
import "./PostaStorageV3.sol";

contract PostaV3 is Initializable, OwnableUpgradeable, ERC721Upgradeable, PostaStorageV3 {
    ...
    function setMeimouVal(uint256 meimouVal) public onlyOwner {
        _meimouVal = meimouVal;
    }

    function getMeimouVal() public onlyOwner returns (uint256) {
        return _meimouVal;
    }
}