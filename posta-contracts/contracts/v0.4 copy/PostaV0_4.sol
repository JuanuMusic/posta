...
contract PostaV0_4 is Initializable, OwnableUpgradeable, ERC721Upgradeable, PostaStorage {
    ...
    event SupportGiven(uint256 indexed tokenId, address indexed supporter, uint256 amount);
    ...
    function support(uint256 tokenId, uint256 ubiAmount) public tokenExists(tokenId) {
        ...
        emit SupportGiven(tokenId, _msgSender(), ubiAmount);
    }
