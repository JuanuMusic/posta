    ...
    <Container className="p-0">
      <Card bg="dark">
        ...
        <Container className="text-light px-4 py-2">
          <h3 className="text-warning">Are you Human?</h3>
          <p>
            It looks like you are not registered on Proof of Humanity. </p><p>Go to <a href="https://app.proofofhumanity.gov/" className="text-warning">Proof of Humanity</a> and register your rightfully owned identity.<br />
